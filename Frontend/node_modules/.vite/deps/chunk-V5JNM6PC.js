import {
  NoSsr,
  Popper
} from "./chunk-DUJGVRPH.js";
import {
  useSlotProps
} from "./chunk-B3IXAQTJ.js";
import {
  Typography_default
} from "./chunk-WAL355K3.js";
import {
  useTheme
} from "./chunk-ULGUAY3X.js";
import {
  shouldForwardProp
} from "./chunk-EXW6A4KA.js";
import {
  init_ownerWindow,
  init_useControlled,
  ...
  useForkRef,
  useId
} from "./chunk-QAHTRPOE.js";
import {
  styled_default
} from "./chunk-433N6S6Y.js";
import {
  _extends,
...
} from "./chunk-T6IUTUEU.js";
import {
  require_prop_types
} from "./chunk-GRO3EMXU.js";
import {
  require_jsx_runtime
...
function useHighlighted() {
  const highlighted = React9.useContext(HighlightedContext);
...
function useItemHighlighted(item) {
  const highlighted = React10.useContext(HighlightedContext);
  if (highlighted === void 0) {
    throw new Error(["MUI X: Could not find the highlighted ref context.", "It looks like you rendered your component outside of a ChartsContainer parent component."].join("\n"));
  }
  if (!item) {
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React15.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React16.createElement(Provider, { value: props }, children);
};
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime7.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime7.jsxs)(React20.Fragment, {
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React24.useRef({
    x: -1,
    y: -1
  });
  React24.useEffect(() => {
...
var ChartsSurface = React25.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
...
var ChartContainer = React26.forwardRef(function ChartContainer2(props, ref) {
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime11.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime11.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime11.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime11.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime11.jsx)(HighlightedProvider, {
            highlightedItem,
            onHighlightChange,
            children: (0, import_jsx_runtime11.jsxs)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
              ...
              desc,
              disableAxisListener,
              children: [(0, import_jsx_runtime11.jsx)(ChartsAxesGradients, {}), children]
            })
          })
        })
      })
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  ...
  const displayError = React27.useRef(false);
...
var ResponsiveChartContainer = React28.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width && height ? (0, import_jsx_runtime12.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
function ChartsText(props) {
  ...
  const wordsByLines = React29.useMemo(() => getWordsByLines({
    style,
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React31.useContext(CartesianContext), _ref = props.axisId ?? xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.xAxis[_ref], _excluded5);
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React32.useContext(CartesianContext), _ref = props.axisId ?? yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.yAxis[_ref], _excluded6);
...
function ChartsLegend(inProps) {
  ...
  return (0, import_jsx_runtime23.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
//# sourceMappingURL=chunk-V5JNM6PC.js.map
